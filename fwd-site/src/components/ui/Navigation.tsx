      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-32 py-4">
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map(link => (
              ...
              >
                {link.dropdown ? (
                  <button
                    type="button"
                    className="relative text-gray-800 hover:text-ai-purple transition-colors font-medium cursor-pointer flex items-center gap-1 bg-transparent border-0 p-0"
                  ...
                  >
                    ...
                    {link.badge && (
                      <span className="absolute -top-2 -right-12 bg-amber-700 text-white text-xs font-semibold px-2 py-0.5 rounded-full whitespace-nowrap">
                        {link.badge}
                      </span>
                    )}
                  </button>
            ...
            {/* WhatsApp Button */}
            <a
              href="https://wa.me/447584417830"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-green-700 hover:bg-green-800 transition-colors"
        ...
        <div className="container mx-auto px-6 py-8">
              ...
              <div key={link.href}>
                {link.dropdown ? (
                  ...
                  >
                    {link.label}
                    {link.badge && (
                      <span className="ml-2 bg-amber-700 text-white text-xs font-semibold px-2 py-0.5 rounded-full">
                        {link.badge}
                      </span>
                    )}
                  </a>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center gap-3 bg-green-700 hover:bg-green-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors w-full justify-center"
            >
